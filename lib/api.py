...
def get_video_detail(mid):
    # Get the video details by a ID from the API
    common.plugin.log('get_video_detail')

    url = common.rtbf_url + 'api/media/video'
    ...
    common.plugin.log("api.get_video_detail media #{0}".format(mid))
